      ...
      {show && (
        ...
        >
          <div class="relative p-4 w-full md:w-[60%] left-0 md:left-[16%] top-0 md:top-[20%] h-full md:h-auto">
            <div class=" top-30 relative bg-white rounded-lg shadow">
              <div class="flex justify-between items-start p-4 rounded-t border-b">
                <div className="flex flex-col">
                  <h3 class="text-xl font-semibold text-gray-900">
                    {data.title}
                  </h3>
                  <p class="text-base leading-relaxed text-gray-500 mt-2">
                    {data.name}
                  </p>
                </div>
                <button
              ...
              <div class="p-6 space-y-6">
                <p class="flex text-base leading-relaxed text-gray-500">
                ...
                <div>
                  <p class="flex text-base leading-relaxed">Posted on</p>
