...
const JobEditModel = ({ currentUser }) => {
	...
	const jobStartTimingRef = useRef();
	const jobEndTimeRef = useRef();
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			await postJob(
				...
				jobStartTimingRef.current.value,
				jobEndTimeRef.current.value,
				jobSalaryRef.current.value,
				jobSkillsRef.current.value,
	...
	return (
		<div>
			...
			{jobForm && (
				<div class='modal fixed top-0 left-0 w-full h-full outline-none overflow-x-hidden overflow-y-auto z-40'>
						...
						<div class='modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current'>
							<div class='modal-header flex flex-shrink-0 items-center justify-between p-4 border-b border-gray-200 rounded-t-md'>
								...
								<button
									...
									aria-label='Close'
									onClick={(e) => setJobform(!jobForm)}></button>
							</div>
